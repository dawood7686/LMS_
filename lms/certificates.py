...
def generate_certificate(name, course_title, completion_date, image_path):
    # Load the certificate template image
    template_path = f'{os.getcwd()}/media/media/certificate.jpg' # Replace with the path to your certificate template image
    certificate_img = Image.open(template_path)

    # Define fonts and font sizes
    name_font = ImageFont.truetype(f'{os.getcwd()}/media/media/font/ten.ttf', 50)  # Replace with the path to the font file for the name
    title_font = ImageFont.truetype(f'{os.getcwd()}/media/media/font/ten.ttf', 50)  # Replace with the path to the font file for the title
    date_font = ImageFont.truetype(f'{os.getcwd()}/media/media/font/ten.ttf', 40)  # Replace with the path to the font file for the date

    # Load the image to be placed on the certificate
    image = Image.open(f'{os.getcwd()}/media/media/dp_image11-796.jpg')
